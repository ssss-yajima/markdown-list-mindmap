...
} from '../helpers/regenerateFromTree'
import {
...
export function createNodeOperationsSlice(
  ...
  return {
    ...
    addChildNode: (parentId: string, text = 'New Node') => {
      let resultNodeId: string | null = null
      const success = applyTreeOperation(
        set,
        get,
        (items, metadata) => {
    ...
    addSiblingNode: (siblingId: string, text = 'New Node') => {
      let resultNodeId: string | null = null
      const success = applyTreeOperation(
        set,
        get,
    ...
    addSiblingNodeBefore: (siblingId: string, text = 'New Node') => {
      let resultNodeId: string | null = null
      const success = applyTreeOperation(
        set,
        get,
